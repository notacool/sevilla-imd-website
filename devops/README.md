...
prod:
  hosts:
    imd.notacoolcompany.com:
      ansible_user: root
      host: imd
      hostname: imd.notacoolcompany.com
```
...
Deploy the stack defined in `devops/stacks/imd.notacoolcompany.com.yml` to the remote server with:
