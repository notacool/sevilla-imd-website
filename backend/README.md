...
Install sevilla.imd.website with uv.

```shell
uv add sevilla.imd.website
```
...
Generated from the [`cookieplone-templates`  template](https://github.com/plone/cookieplone-templates/tree/main/) on 2025-06-20 16:49:42.. A special thanks to all contributors and supporters!
